...
Stage 1 is in progress. The repository contains a working Avalonia app shell with dark styling, sidebar navigation, Dashboard window counts, a Window Manager page, native topmost pin/unpin support, initial Core abstractions, a Windows service layer, and basic tests.
