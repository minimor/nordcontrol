...
Stage 1 bootstrap is in progress. The repository contains a working Avalonia app shell with dark styling, sidebar navigation, placeholder module pages, initial Core abstractions, a Windows service layer placeholder, and basic tests.
